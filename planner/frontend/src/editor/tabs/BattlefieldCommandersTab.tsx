...
const inputSmall: React.CSSProperties = {
  width: 70, background: '#6e7c83', border: '1px solid #4a5258',
...
export function BattlefieldCommandersTab() {
  ...
  const coalColors: Record<string, string> = {
    blue: '#d49a30', red: '#d95050', neutrals: '#8a8a6a',
  };
  ...
  return (
    <div style={{ maxWidth: 850 }}>
      ...
      <p style={{ margin: '0 0 6px', fontSize: 12, color: '#3a4248' }}>
        Set up Combined Arms player slots and JTAC designations for ground and naval units.
      </p>
      <p style={{ margin: '0 0 14px', fontSize: 11, color: '#4a5258' }}>
      ...
      {groundGroups.length === 0 ? (
        ...
        <>
            ...
            return (
              <div key={coal} style={cardStyle}>
                <div style={{ ...sectionLabel, color, display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <span style={{ fontSize: 11, fontWeight: 400, color: '#3a4248', marginLeft: 4 }}>
                  ...
                  <div key={group.groupId} style={{ marginBottom: 8 }}>
                    ...
                    <div style={{
                      ...
                      <span style={{
                        ...
                        color: group.category === 'ship' ? '#d49a30' : '#8a8a6a',
                      }}>
                        {group.category === 'ship' ? 'NAVAL' : 'GROUND'}
                      </span>
                      {group.task && (
                        <span style={{ fontSize: 10, color: '#4a5258' }}>
                          Task: {group.task}
                        </span>
                      )}
                    </div>
                    ...
                    {group.units.map((unit) => {
                      ...
                      return (
                        <div key={unit.unitId} style={{
                          ...rowStyle,
                          borderColor: caChanged || jtacConfig ? '#d49a3030' : '#8c9ba2',
                          ...
                          <span style={{ color: '#3a4248', minWidth: 120, fontSize: 11 }}>
                            {unit.type}
                          </span>
                          ...
                          <span style={{
                            ...
                            color: willBePlayer ? '#3fb950' : '#3a4248',
                          }}>
          ...
          <div style={{
            ...
            padding: '10px 0', borderTop: '1px solid #4a5258',
          }}>
            <button
              onClick={handleApply}
              disabled={!hasChanges}
