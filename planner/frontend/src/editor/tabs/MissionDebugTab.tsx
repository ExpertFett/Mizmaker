...
const severityColors: Record<string, { bg: string; border: string; text: string; icon: string }> = {
  ...
  info: { bg: 'rgba(74, 143, 212, 0.06)', border: '#d49a3030', text: '#d49a30', icon: '\u2139' },
};
...
const btnStyle: React.CSSProperties = {
  ...
  color: '#d49a30', cursor: 'pointer', fontSize: 12, fontWeight: 600,
      ...
      <div style={{
        ...
        {rows.length === 0 ? (
          ...
          <div key={k} style={{ padding: '1px 0', display: 'flex', gap: 8 }}>
            <span style={{ color: '#5a6268', flexShrink: 0 }}>{k}:</span>
            <span style={{ color: '#1a1f25', overflow: 'hidden', textOverflow: 'ellipsis' }}>
              {v}
            </span>
          </div>
        ))}
...
export function MissionDebugTab() {
  ...
  return (
    <div style={{ maxWidth: 850 }}>
      ...
      <p style={{ margin: '0 0 14px', fontSize: 12, color: '#3a4248' }}>
      ...
      {hasRun && !error && (
        <>
          ...
          <div style={{
            ...
            background: '#8c9ba2', borderRadius: 6, border: '1px solid #4a5258',
            alignItems: 'center', flexWrap: 'wrap',
          }}>
            <span style={{ fontSize: 13, fontWeight: 600, color: '#1a1f25', marginRight: 8 }}>
            ...
            <div style={{
              ...
              color: counts.warning > 0 ? '#d29922' : '#3a4248',
              fontSize: 12, fontWeight: 600,
            }}>
            ...
            <div style={{
              ...
              background: 'rgba(74, 143, 212, 0.08)', color: '#d49a30',
              fontSize: 12, fontWeight: 600,
            }}>
              {counts.info} info
            </div>
          ...
          <div style={{ display: 'flex', gap: 6, marginBottom: 12, flexWrap: 'wrap', alignItems: 'center' }}>
            <span style={{ fontSize: 11, color: '#3a4248', marginRight: 4 }}>Severity:</span>
            ...
            <span style={{ fontSize: 11, color: '#3a4248', marginLeft: 12, marginRight: 4 }}>Category:</span>
            <button
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 2, flexWrap: 'wrap' }}>
                          ...
                          <span style={{
                            ...
                            background: 'rgba(90, 122, 138, 0.15)', color: '#3a4248',
                          }}>
                            {issue.category}
                          </span>
                          {isApplied && (
                        ...
                        {(issue.groupName || issue.unitName) && (
                          <div style={{ marginTop: 3, fontSize: 11, color: '#4a5258' }}>
                    ...
                    {fix && isExpanded && (
                      <div style={{
                        ...
                        <div style={{ display: 'flex', gap: 12, marginBottom: 10 }}>
                          ...
                          <div style={{
                            color: '#5a6268', fontSize: 16, alignSelf: 'center',
                            padding: '0 4px',
                          }}>→</div>
