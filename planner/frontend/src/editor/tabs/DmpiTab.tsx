    ...
    <div style={{ maxWidth: 900 }}>
      ...
      {dmpis.length === 0 ? (
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
          <thead>
            <tr style={{ borderBottom: '2px solid #1a2a3a' }}>
              <th style={thStyle}>#</th>
          ...
          <tbody>
            {dmpis.map((d, i) => (
              <tr key={d.id} style={{ borderBottom: '1px solid #0f1a28' }}>
...
const inputStyle: React.CSSProperties = {
  ...
  color: '#8fa8c0', fontSize: 12, padding: '3px 6px', fontFamily: 'inherit',
};
