-- ============================================================================
-- ShipTraffic-Sinai.lua - civilian shipping traffic for the Sinai map
...
ShipTrafficCFG = {
  ...
  lanes = {
    {
      ...
      cad = 1800,
      speed = 8,
      types = { "Dry-cargo ship-1", "Dry-cargo ship-2", "HandyWind", "ELNYA", "Seawise_Giant" },
      seed = 10,
      fixes = {
        {
          x = -429381,
  ...
  fishing = {
    {
      name = "HRGF",
      box = { -330000, -285000, 255000, 295000 },
      types = { "ZWEZDNY" },
      maxActive = 8,
      cad = 900
    },
    {
      name = "MEDF",
      box = { 142000, 165000, -120000, -40000 },
      types = { "ZWEZDNY" },
      maxActive = 6,
      cad = 1200
    },
