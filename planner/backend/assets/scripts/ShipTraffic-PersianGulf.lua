-- ============================================================================
-- ShipTraffic-PersianGulf.lua - civilian shipping traffic for the PersianGulf map
  ...
  lanes = {
    {
      ...
      cad = 1200,
      speed = 7,
      types = { "ELNYA", "Seawise_Giant", "HandyWind", "Dry-cargo ship-1", "Dry-cargo ship-2" },
      seed = 20,
      fixes = {
        {
          x = -117689,
